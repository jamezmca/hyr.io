...
const plans = [
    {
        name: 'Free',
        description: 'For your personal resume',
        price: 'Free',
        interval: 'Free, Forever',
        features: [
            'Personal resume link',
            'Professional resume builder',
            'Manage up to 3 cover letters',
            'Cover letter assistance',
            // 'Limited free cover letter generations'
        ],
        recommended: false
    },
    {
        ...
        features: [
            ...
            // 'Build numerous professional resumes',
            'Save & share up to 20 cover letters',
            'Instant cover letter generation',
            'Remove the Hyr.sh watermark',
            'Guides for the perfect job application',
        ],
        recommended: true
    },
]
